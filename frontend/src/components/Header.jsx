...
export function Header() {
  ...
  return (
    ...
    {/* BOTTOM AREA */}
    <div className='nav-links duration-500 hidden  md:block   bg-white md:min-h-fit min-h-0 left-0 top-[-100%] md:w-auto  w-full flex items-center justify-center px-5 py-1.5 '>
