...
export const getProducts = async () => {
  ...
  try {
    const response = await fetch(`${apiUrl}/productos?populate[portada][fields][0]=url&populate[subcategoria][fields][0]=nombre&populate[subcategoria][fields][1]=categoria&populate[marca][fields][0]=nombre`);
    if (response.ok) {
